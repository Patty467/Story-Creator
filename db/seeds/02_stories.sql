...
-- Uncompleted Stories
  ...
  (id, title, content, completed, uers_id) 
  VALUES (
  1, 
  'Harmonic Dust', 
  'The parched earth groaned under a relentless sun, the horizon shimmering like a mirage above the cracked and dusty plains. 
  ...
  a storm brewing not just in the sky, but in the depths of his soul.', 
  false,
  1
  );
  
  (id, title, content, completed, users_id) 
  VALUES (
  2, 
  'Through the Skylight', 
  'Rain pummeled the corrugated metal roof of the gym, drumming a chaotic rhythm against the echoes of squeaking sneakers and grunts of exertion. 
  ...
  anything to break free from the gravity of her small-town dreams.', 
  false,
  1
  );
  ...
  3, 
  'Whinnying for Wings', 
  'The sun, a giant orange yolk smeared across the stable ceiling, oozed its morning light onto Buttercup. 
  ...
  Maybe, just maybe, this could be the day she finally took flight, no wings needed, just pure, feathery desire and a pond full of possibilities.', 
  false,
  2
  );
  ...
  'A crackle of static birthed a neon butterfly from the television screen, its wings morphing into tangled constellations before melting into a puddle of pixels. 
  ...
  ready to tumble down the rabbit hole into a labyrinth of her own making.', 
  false,
  2
  );
...
-- Completed stories
  ...
  5, 
  'Duck-Duck, The Duck', 
  'Duck-Duck, the Duck, wasn''t like the other ducks. While his buddies bobbed merrily on the pond, quacking away about worms and puddles, 
  ...
  the most beautiful wings are the ones woven from dreams.', 
  true,
  1
  );
  ...
  VALUES (
  6, 
  'Concrete Jungles and Manicured Lawns: A Streetwise Prince in Bel-Air', 
  '
  ...
  your own version of Bel-Air. And somewhere, between the manicured lawns and the concrete jungle, I found mine.', 
  true,
  1
  );
  ...
  VALUES (
  7, 
  'The Case of the Crumb Caper: One Duck Detective''s Quacking Adventure', 
  'Beatrice Beefeater, duck detective extraordinaire, wasn''t your average puddle pouncer. 
  ...
  Beatrice Beefeater, the clumsiest, most breadcrumb-obsessed detective around, was just the duck for the job.', 
  true,
  3
  );